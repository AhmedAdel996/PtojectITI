...
namespace FinalProjectITI.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Category_ID,Category_Name,Category_Describtion")] Category category)
        {
            ViewBag.categories_Names = categoryservice.GetAll();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Category_ID,Category_Name,Category_Describtion")] Category category)
        {
